var canvas;
        ...
        function drawNet(){
            for(var i=0;i<=canvas.height;i+=40){
                colorRect(canvas.width/2-1,i,2,20,'rgb(77, 179, 52)');                     }
        }
        
        function drawFun(){
        // next line blanks out the screen with black    
        colorRect(0,0,canvas.width,canvas.height,'rgb(17, 86, 0)');
        
        if(showingWinScreen){
        canvasContext.fillStyle='rgb(77, 179, 52)';
        ...
        colorRect(0,paddle1Y,
                  PADDLE_THICKNESS,PADDLE_HEIGHT,'rgb(77, 179, 52)');
            
        // this is the right player paddle
        colorRect(canvas.width-PADDLE_THICKNESS,
                  paddle2Y,PADDLE_THICKNESS,PADDLE_HEIGHT,'rgb(77, 179, 52)');
            
        // calling function to draw ball    
        colorCircle(ballX,ballY,10,'whitergb(77, 179, 52)');    
